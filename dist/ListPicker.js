...
function (_React$PureComponent) {
  ...
  _createClass(ListPicker, [{
    ...
    value: function render() {
      ...
      var renderLinearProgress = React.createElement(React.Fragment, null, this.props.loading && React.createElement(LinearProgress, null));
      ...
      }, renderLinearProgress, React.createElement(DialogContent, null, renderItems));
      var mobileDialog = React.createElement(Dialog, {
        ...
        fullWidth: true,
        maxWidth: "sm"
      }, renderLinearProgress, React.createElement(CustomDialogTitle, null, React.createElement(IconButton, {
