...
var CustomContent = styled(CardContent)(_templateObject6(), function (_ref) {
  var theme = _ref.theme;
  return theme.mui.spacing.unit * 2;
});
var CustomMedia = styled(CardMedia)(_templateObject7());
  ...
  _createClass(CardReport, [{
    ...
    value: function render() {
      ...
      var report = React.createElement(CustomContent, null, React.createElement(TitleContainer, null, React.createElement(Tooltip, {
        ...
        gutterBottom: true,
        variant: "body1"
      }, translate(_.capitalize(this.props.options.title)))), React.createElement(CustomIconButton, {
        color: "primary",
      ...
      }, React.createElement("div", null, React.createElement(CustomMedia, {
        component: "img",
