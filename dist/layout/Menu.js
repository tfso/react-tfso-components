...
})(["&&{color:", ";min-width:36px;}"], function (_ref9) {
...
export var MenuGroup = withScreenSize((_temp =
/*#__PURE__*/
function (_React$PureComponent2) {
  ...
  _createClass(MenuGroup, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement(MenuGroupListItem, Object.assign({
        ContainerProps: {
          style: {
            top: 0,
...
function (_React$PureComponent3) {
  ...
  _createClass(MenuRootItem, [{
    ...
    value: function render() {
      ...
      }, this.props.label, React.createElement("div", null, React.createElement(ListItemSecondaryText, {
        variant: "caption",
        noWrap: true,
        style: {
          display: 'block'
