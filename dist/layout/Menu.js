...
var ListItemWrapper = function ListItemWrapper(_ref5) {
  var expanded = _ref5.expanded,
      ...
      props = _objectWithoutProperties(_ref5, ["expanded", "disabled"]);
...
var MenuGroupListItem = _styled(ListItemWrapper).withConfig({
...
})(["&&{background-color:", ";color:", ";> a{text-decoration:none;}:focus:hover,:hover{background-color:", ";};}"], function (_ref6) {
  ...
  return theme.mui.palette.action.hover;
});
...
var ListItemTextWrapper = function ListItemTextWrapper(_ref11) {
  var selected = _ref11.selected,
      props = _objectWithoutProperties(_ref11, ["selected"]);

  return React.createElement(Typography, props);
};

var StyledListItemTextTypography = _styled(ListItemTextWrapper).withConfig({
  displayName: "StyledListItemTextTypography",
  componentId: "sc-1ryjcne-5"
})(["&&{color:", ";}"], function (props) {
  return props.selected ? props.theme.tfso.colors.menuItemSelectedText : 'inherit';
});
  ...
  _createClass(MenuGroup, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement(MenuGroupListItem, {
        ...
        primary: React.createElement(StyledListItemTextTypography, {
          variant: "body1"
...
})(["&&{background-color:", ";color:", ";> a{text-decoration:none;}:focus:hover,:hover{background-color:", ";};}"], function (_ref12) {
...
function (_React$PureComponent3) {
  ...
  _createClass(MenuRootItem, [{
    ...
    value: function render() {
      ...
      }), this.props.accessDenied && React.createElement(LockIcon, {
        fontSize: "small"
      }));
...
})(["&&{padding-left:52px;background-color:", ";color:", ";:hover{background-color:", ";};> a{text-decoration:none;}}"], function (_ref16) {
...
var Text = _styled.div.withConfig({
  displayName: "Text",
  componentId: "sc-1ryjcne-10"
})(["flex:1;"]);
...
function (_React$PureComponent4) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      var LinkContent = React.createElement(NestedListItem, null, React.createElement(Text, null, Icon && React.createElement(NestedListItemIcon, {
        color: "inherit",
        style: {
          marginRight: 0
        }
      ...
      })), !Badge ? React.createElement(ListItemText, {
        disableTypography: true,
        primary: React.createElement(StyledListItemTextTypography, {
          selected: this.props.selected,
          variant: "body2"
        }, this.props.label)
      }) : React.createElement(Badge, null, React.createElement(ListItemText, {
        disableTypography: true,
        primary: React.createElement(StyledListItemTextTypography, {
          selected: this.props.selected,
          variant: "body2"
