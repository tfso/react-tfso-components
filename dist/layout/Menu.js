...
})(["&&{width:", "px;height:100%;}a,a:hover{text-decoration:none};li:focus{outline:none;}.MuiPaperStyle{position:static;background-color:", ";color:", ";}"], function (_ref) {
  var open = _ref.open;
  return open ? 240 : 0;
}, function (_ref2) {
...
var ListItemWrapper = function ListItemWrapper(_ref9) {
  var expanded = _ref9.expanded,
      disabled = _ref9.disabled,
      props = _objectWithoutProperties(_ref9, ["expanded", "disabled"]);
...
})(["&&{background-color:", ";color:", ";:focus:hover,:hover{background-color:", ";};}"], function (_ref10) {
...
})(["&&{background-color:", ";color:", ";&&.styled-selected{background-color:", ";color:", ";};:focus:hover,:hover{background-color:", ";};}"], function (_ref15) {
...
})(["&&{padding-left:52px;background-color:", ";color:", ";:hover{background-color:", ";};}"], function (_ref21) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      var LinkContent = React.createElement(NestedListItem, {
        selected: this.props.selected
      }, Icon && React.createElement(NestedListItemIcon, {
        color: "inherit",
        style: {
          marginRight: 0
        }
