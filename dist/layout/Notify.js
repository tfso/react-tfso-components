import _regeneratorRuntime from "C:\\projects\\react-tfso-components\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/regenerator";
...
var NotificationItem = function NotificationItem(props) {
  ...
  }, [props.date]); // const AvatarWrapper = React.useMemo(() => ({children, ...innerProps}) => {
...
function (_React$PureComponent) {
  ...
  function Notifier() {
    ...
    _regeneratorRuntime.mark(function _callee() {
      var _this$props, onOpen, onSeen;

      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$props = _this.props, onOpen = _this$props.onOpen, onSeen = _this$props.onSeen;
    ...
    _this.renderToolbar = function (mobile) {
      return React.createElement(React.Fragment, null, React.createElement(Toolbar, {
        ...
        color: "primary",
        fullWidth: true
      }, _this.props.readAllButtonText)))), React.createElement(Divider, null), _this.renderLoading());
    };
    ...
    _this.renderLoadingMore = function () {
      return _this.props.loadingMore ? React.createElement(Delay, {
        delayMs: 200
  ...
  _createClass(Notifier, [{
    ...
    value: function renderDesktop() {
      ...
      }, this.renderToolbar(false), this.renderContent(false), this.renderLoadingMore());
    }
  }, {
    key: "renderMobile",
    value: function renderMobile() {
      ...
      }, this.renderToolbar(true), React.createElement(CloseIconButton, {
        onClick: this.onClose
      }, React.createElement(CloseIcon, null))), React.createElement(DialogContent, null, this.renderContent(true), this.renderLoadingMore()));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, this.renderNotifyer(), React.createElement(ScreenSize, null, function (_ref7) {
