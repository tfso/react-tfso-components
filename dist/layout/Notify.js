...
var CloseIconButton = styled(IconButton)(_templateObject(), function (_ref) {
  ...
  return theme.mui.spacing();
}, function (_ref2) {
  var theme = _ref2.theme;
  return theme.mui.spacing();
}); // const ListItemWrapper = ({read, ...props}: ListItemProps & {read?: boolean}) => <ListItem {...props} />

var ReadListItem = styled(ListItem)(_templateObject2(), function (_ref3) {
  var read = _ref3.read,
      theme = _ref3.theme;
...
function (_React$PureComponent) {
  ...
  _createClass(Notifier, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, this.renderNotifyer(), React.createElement(ScreenSize, null, function (_ref5) {
