...
var ProfileCardContent = _styled(CardContent).withConfig({
  ...
  var theme = _ref.theme,
      color = _ref.color;
  return color || theme.tfso.palette.primaryLight;
});
...
})(["flex:1;padding:", "px;;"], function (_ref5) {
  ...
  function ProfileCard() {
    ...
    _this.renderContent = function () {
      return React.createElement(CustomCard, null, React.createElement(ProfileCardContent, null, React.createElement(ProfileAvatar, {
        ...
        "aria-label": "{this.props.identity.profile.firstName}"
        ...
        variant: "body2"
      }, _this.props.identity.profile.identifier))), React.createElement(Divider, null), React.createElement(CustomCardContent, null, _this.props.children), React.createElement(CardActions, null, React.createElement(Right, null, React.createElement(Button, {
        variant: "outlined",
        size: "small",
        color: "secondary",
        onClick: _this.onSignOut
      }, _this.props.signOutText))));
    };
