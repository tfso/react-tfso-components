...
export declare class MenuGroup extends React.PureComponent<MenuGroupProps> {
    static propTypes: {
        icon: PropTypes.Validator<PropTypes.ReactComponentLike>;
        subtitle: PropTypes.Validator<string>;
        label: PropTypes.Validator<string>;
        onToggleExpanded: PropTypes.Validator<(...args: any[]) => any>;
        expanded: PropTypes.Validator<boolean>;
        children: PropTypes.Validator<string | number | boolean | {} | PropTypes.ReactElementLike | PropTypes.ReactNodeArray>;
        accessDenied: PropTypes.Requireable<boolean>;
    };
    onToggleExpanded: (e: any) => void;
    render(): JSX.Element;
}
...
export declare class MenuItem extends React.PureComponent<MenuItemProps> {
    static propTypes: {
        ...
        accessDenied: PropTypes.Requireable<boolean>;
        href: PropTypes.Requireable<string | ((...args: any[]) => any)>;
        badge: PropTypes.Requireable<(...args: any[]) => any>;
    };
    render(): JSX.Element;
}
