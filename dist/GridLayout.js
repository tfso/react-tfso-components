...
function (_React$PureComponent) {
  ...
  function GridLayout() {
    ...
    _this.onDragResizeStop = function (layout, oldItem, newItem) {
  ...
  _createClass(GridLayout, [{
    ...
    value: function render() {
      ...
      return React.createElement(ReactGridLayout, {
        ...
        autoSize: true,
        measureBeforeMount: true // width= // TODO: set this one such that width is fixed, should be someting large, but not too large... hmm.
        ,
