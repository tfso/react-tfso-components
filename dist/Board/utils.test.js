import { calculateBoardHeight, calculateBoardRows, calculateItemDimensions, calculateItemLayout, getBreakpointFromWidth, compact, moveItem, addBoardItem } from // removeBoardItem,
// showBoardItem,
// hideBoardItem,
'./utils';
...
describe('utils', function () {
  ...
  describe('compact', function () {
    it('compacts moves an item that fits above other items up', function () {
      var component = null;
      var items = {
        a: {
          key: 'a',
      ...
      var newItems = compact(items, 'desktop');
