...
declare type GridItemHeight = 1 | 2 | 3 | 4 | 5 | 6;
export declare type GridItem = {
    id: string;
    backgroundColor?: string;
    children: React.ReactNode;
};
declare type GridItemPosition = {
    id: string;
    col: number;
    row: number;
    width: GridItemWidth;
...
export default class GridLayout extends React.PureComponent<GridLayoutProps> {
    ...
    static propTypes: {
        ...
        compactType: PropTypes.Requireable<string | null>;
    ...
    onLayoutChange: (layouts: ReactGridLayout.Layout[]) => void;
    validateItemLayout: () => void;
    onResize: (layout: ReactGridLayout.Layout[], oldItem: ReactGridLayout.Layout, newItem: ReactGridLayout.Layout, placeHolder: ReactGridLayout.Layout) => void;
    onDragStop: (layout: ReactGridLayout.Layout[], oldItem: ReactGridLayout.Layout, newItem: ReactGridLayout.Layout, placeHolder: ReactGridLayout.Layout) => void;
    onResizeStop: (layout: ReactGridLayout.Layout[], oldItem: ReactGridLayout.Layout, newItem: ReactGridLayout.Layout, placeHolder: ReactGridLayout.Layout) => void;
    render(): JSX.Element;
}
export {};
