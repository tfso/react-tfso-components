...
var Board = function Board(props) {
  ...
  var _React$useState9 = React.useState(1920),
      ...
      setWidth = _React$useState10[1]; // Board dimensions
  ...
  var height = useHeight(props, screenType);
  ...
  var onDragStop = React.useCallback(function () {
    ...
    var newItems = _objectSpread({}, items, _defineProperty({}, activeDrag.key, item));
