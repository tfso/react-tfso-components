...
import Typography from '@material-ui/core/Typography'; // import {Translate} from '../types'
...
})(["&&{width:100%;height:100%;padding:50px;display:flex;align-items:center;justify-content:center;text-align:center;}"]);

var CustomLockIcon = _styled(LockIcon).withConfig({
  displayName: "CustomLockIcon",
  componentId: "gm57fw-2"
})([" &&{position:absolute;z-index:1;color:rgba(0,0,0,0.1);font-size:25em;transform:translate(-50 %,-50 %);display:flex;flex-wrap:wrap;align-items:center;}"]);
...
function (_React$PureComponent) {
  ...
  _createClass(AccessDenied, [{
    ...
    value: function render() {
      return React.createElement(CustomPaper, null, React.createElement(CustomLockIcon, null), React.createElement(CustomDiv, null, React.createElement(Typography, {
        variant: "h3"
      }, this.props.translate('Access Denied')), " ", React.createElement("br", null), React.createElement(Typography, {
        variant: "body1"
      }, this.props.translate('accessdenieddescription')), React.createElement("ul", {
        style: {
          listStyle: 'none',
          padding: 0,
          fontWeight: 'bold'
      ...
      }, this.props.translate('Request access')), React.createElement("br", null), React.createElement(Link, {
        onClick: this.goBack
      }, this.props.translate('Go back'))));
    }
  }]);
