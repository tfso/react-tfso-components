...
function (_React$PureComponent) {
  ...
  _createClass(AccessDenied, [{
    ...
    value: function render() {
      ...
      var content = React.createElement(React.Fragment, null, React.createElement(Typography, {
        variant: "h3"
      }, translate('Access Denied')), " ", React.createElement("br", null), React.createElement(Typography, {
        variant: "body1"
      }, translate('Accessdenied_description')), React.createElement(List, null, modules.map(function (module) {
      ...
      var desktopView = React.createElement(CustomPaper, null, React.createElement(CustomLockIcon, null), React.createElement(CustomDiv, null, content));
      var mobileView = React.createElement(CustomPaper, null, React.createElement(CustomLockIcon, null), React.createElement("div", null, content));
